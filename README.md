...
*Note that the design block diagram below is not the final version of the actually implemented CPU. Several changes(including routing) have been made to the design after drawing this block diagram *
