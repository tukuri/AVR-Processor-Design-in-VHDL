...
**Note that the CPU block diagram below is not the final version of the actually implemented CPU. Several changes (such as routing) have been made to the design after drawing this block diagram.**
