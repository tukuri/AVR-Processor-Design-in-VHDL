...
Branch instructions such as JMP, CALL, RET take 3 or 4 cycles. These branch instructions perform updating the Stack Pointers as well.
...
**Note that the processor's block diagram below is not the final version of the actually implemented processor. Several changes (such as routing) have been made to the design after drawing this block diagram.**
